  ...
  return (
    <div className="bg-white/[0.03] border border-white/8 rounded-lg p-4 flex items-center gap-4">
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="font-sans text-[0.75rem] text-white/50 mt-0.5">{profile.discipline}</div>
        <div className="flex items-center gap-1.5 text-white/45 mt-1">
        ...
        {profile.status === 'incoming' && (
          <div className="flex items-center gap-1.5">
            ...
            <button
              ...
              className="w-8 h-8 flex items-center justify-center rounded hover-white-tint text-white/60 hover:text-white/90 transition-colors"
            >
